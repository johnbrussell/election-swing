...
The data used is a self-cleaned version of the MIT Election Data and Science Lab dataset, "County Presidential Election Returns 2000-2020", available at https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/VOQCHQ. The data cleaning was mostly removing duplicate data (eg., for counties that have rows for votes by type (absentee, in person) and a row for total votes), county name differences or changes between elections, and disambiguating Virginia cities and counties.
